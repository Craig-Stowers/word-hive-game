...
const ScreenManager = ({
    ...
    const extendedCustomActions = wrapFunctions(
        currentScreenConfig.actions || {},
        passProps
    );
    ...
    const renderedScreen = wrapComponent(
        <ScreenComponent {...screenComponentProps} />,
        wrappers
    );
